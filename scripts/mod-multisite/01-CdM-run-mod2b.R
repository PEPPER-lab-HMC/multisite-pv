...
summary(m1) # R2 = 0.995, slope = 0.9932
...
#### Write out TLPs ####
write_csv(pred,
          file = "data_clean/JAGS-model-outputs/CdM-model-outputs/CdM_model_pred.csv")
write_csv(cps,
          file = "data_clean/JAGS-model-outputs/CdM-model-outputs/CdM_model_cps.csv")
write_csv(tlps,
          file = "data_clean/JAGS-model-outputs/CdM-model-outputs/CdM_model_tlps.csv")
write_csv(ds,
          file = "data_clean/JAGS-model-outputs/CdM-model-outputs/CdM_model_ds.csv")
write_csv(cs,
          file = "data_clean/JAGS-model-outputs/CdM-model-outputs/CdM_model_cs.csv")
