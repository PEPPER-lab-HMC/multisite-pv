...
pv <- read_csv("data_clean/03-pv-curve-data/ONAQ_pv_curve.csv") |>
  ...
  mutate(P.MPa = abs(P.MPa), ID = case_when(ID == "2b" ~ 1,
                                            ID == "3a" ~ 2,
                                            ID == "4a" ~ 3,
                                            ID == "5b" ~ 4,
                                            ID == "6" ~ 5,
...
write_csv(cps,
          file = "data_clean/JAGS-model-outputs/ONAQ-model-outputs/ONAQ_model_cps.csv")
write_csv(tlps,
          file = "data_clean/JAGS-model-outputs/ONAQ-model-outputs/ONAQ_model_tlps.csv")
write_csv(ds,
